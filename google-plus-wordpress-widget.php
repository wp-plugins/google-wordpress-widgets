...
function gplus_style(){
	echo '<style type="text/css">.widget_google_plus{border:none;background-color:#F2F2F2;-moz-border-radius:5px;-khtml-border-radius:5px;-webkit-border-radius:5px;border-radius:5px;padding:1px;}.plus .updates{background-color:#fff;margin:1px;padding:6px 11px 6px 11px;border:none;}.widget_google_plus .widget-title,.widget_google_plus .widgettitle{background-color:#F2F2F2;height:48px;padding:9px 12px 8px 12px;margin-bottom:1px;border:none;}img.plus{border:none;float:left;margin-right:10px;-moz-border-radius:5px;-khtml-border-radius:5px;-webkit-border-radius:5px;border-radius:5px;-webkit-box-shadow:2px 2px 4px rgba(0,0, 0, 0.3);-moz-box-shadow:2px 2px 4px rgba(0,0, 0, 0.3);box-shadow:2px 2px 4px rgba(0,0, 0, 0.3);}img.plus:hover{margin-right:6px;-moz-border-radius:40px;-khtml-border-radius:40px;-webkit-border-radius:40px;border-radius:40px;border:solid 2px #00CD00;}span.note {display:block;color:#ccc;}span.credit{text-align:right;margin-top:5px;margin-bottom:8px;margin-right:5px;background-color:#F2F2F2;display:block;}</style>';
}
...
class Google_Plus_Widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		if ( !$gson = wp_cache_get( 'widget-gplus-' . $this->number , 'widget' ) ) {
			$google_json_url = esc_url_raw( 'https://www.googleapis.com/buzz/v1/people/'. $account .'/@self?alt=json&key=AIzaSyCE08aKDMh4dXsfhjbcBtr6SvR0TDUadxc' );
			...
			wp_cache_add( 'widget-gplus-' . $this->number, $gson, 'widget', 86400);
