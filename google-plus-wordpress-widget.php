...
class Google_Plus_Widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		echo "<div class='widget_google_plus'><div class='author-box'><a rel='author' class='plus_person' target='_blank' title='Add to circles' href='" . esc_url( "https://plus.google.com/{$account}" ) . "?rel=author'>+<strong>" . $g_title . "</strong></a> on    <a href='" . esc_url( "https://plus.google.com/{$account}" ) . "'
           ...
           onmouseout=\"document.plus_avatar.src='https://www.google.com/images/icons/ui/gprofile_button-32.png'\">

           <img title='" . $g_title . "' name ='plus_avatar' class='plus' src='https://www.google.com/images/icons/ui/gprofile_button-32.png' alt='google' height='32' width='32' /></div>";
		...
		if ( !$hideupdates ) {
			...
			if ( !$hidecredit ) {
				?>
					<div class="credit"><a class="c" onclick="document.getElementById('code-<?php echo $account; ?>').style.display='';return false;" href="">Scan Me</a><a class="cb" href="http://patrick.bloggles.info/2011/08/01/google-plus-wordpress/">Google+ Widgets</a>
					</div>
				<?php
