...
class Google_Plus_Widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		echo "{$before_widget}{$before_title}<a href='" . esc_url( "https://plus.google.com/{$account}" ) . "'>" . esc_html($title) . "</a>{$after_title}";
		...
		echo "<li><img src='http://ssl.gstatic.com/s2/oz/images/google-logo-plus-0fbe8f0119f4a902429a5991af5db563.png' height='20px' /></li></ul><!-- Powered By Patrick http://patrickchia.com/-->\n";
		$rss->__destruct();
		unset($rss);
