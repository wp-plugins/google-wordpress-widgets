...
?>
<style type="text/css">.widget_google_plus{font-family:arial, hevetica;border:solid 1px #ccc;background-color:#fff;padding:10px; text-align:center;marging-bottom:10px;}a.plus_person{color:#000; font-size:16px;font-weight:normal;height:52px;}img.plus{vertical-align:middle;}.updates{font-weight:normal;color:#777;text-align:left;padding:8px 5px 0px 5px;border-top:solid 1px #E5E5E5;margin-top:12px;}.updates:hover{color:#000;}a.timesince{font-weight:normal;}</style>
<?php
}
...
class Google_Plus_Widget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		echo "{$before_widget}<a rel='author' class='plus_person' target='_blank' title='Add to circles' href='" . esc_url( "https://plus.google.com/{$account}" ) . "'><strong>" . $g_title . "</strong></a> on    <a href='" . esc_url( "https://plus.google.com/{$account}" ) . "'
           ...
           <img title='" . $g_title . "' name ='plus_avatar' class='plus' src='https://ssl.gstatic.com/images/icons/gplus-32.png' alt='google' height='32' width='32' />";
